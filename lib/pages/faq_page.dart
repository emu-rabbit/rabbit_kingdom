...
class FaqPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final faqData = [
      ...
      (
        title: "酒可以一直喝嗎？",
        content: "只要有錢，當然可以一直喝囉，但提醒您不要過量飲酒唷！喝得越多就會越暈，也會需要越久的時間才可以解暈唷，另外注意如果還沒酒退就再喝的話會更暈唷！"
      ),
      (
        title: "交易所的價格是怎樣變動的？",
        content: "交易所的價格會根據市場交易狀況每約30分鐘變動一次，兔兔大帝若是有新公告，也會大幅的影響價格。交易所也會不定期有新的市場消息，也會影響市場價格唷！"
      ),
      (
        title: "為什麼排行榜上寫我沒資料？",
        content: "如果是指買賣價差的話，是因為你沒有買入加上賣出的紀錄，因此導致無法為你計算數值唷！"
      ),
    ];
