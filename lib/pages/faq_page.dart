...
class FaqPage extends StatelessWidget {
  ...
  static final faqData = [
    ...
    (
      title: "個人資產是如何計算的？",
      content: "個人資產以兔兔幣為單位，除了你擁有的兔兔必以外，還會將你擁有的兔兔精華以當前交易所收購價格做計價，總和就是你的資產。畫面右上顯示的皆是個人資產的數值，可以點擊看詳細唷。"
    ),
    (
      title: "兔兔大帝的心情？",
      content: "兔兔王國的所有居民都關心兔兔大帝的心情，大帝的心情也影響了交易所的兔兔精華現價。心情指數越高，則代表兔兔大帝越開心，反之月是心情不好。而不管大帝傷心或是開心，都推薦留言給她唷！"
    ),
  ];
