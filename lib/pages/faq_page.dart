...
class FaqPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final faqData = [
      ...
      (
        title: "酒可以一直喝嗎？",
        content: "只要有錢，當然可以一直喝囉，但提醒您不要過量飲酒唷！暈的效果大概要半小時才會完全消退，請注意如果還沒酒退就再喝的話會更暈唷！"
      ),
      (
        title: "交易所的價格是怎樣變動的？",
        content: "交易所的價格會根據市場交易狀況每約30分鐘變動一次，兔兔大帝若是有新公告，也會大幅的影響價格。而如果兔兔大帝覺得兔兔精華價格過度不利於市場發展，那也許會有王國基金進場干預...？"
      ),
    ];
